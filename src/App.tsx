...
const ONBOARDING_STEPS = [
  { id: 'onb1', text: "👋 Привет! Я твой ИИ-ассистент Holodos. Помогу с покупками, учетом холодильника и подсчетом калорий.", delay: 600 },
  { id: 'onb2', text: "📸 Скинь фото холодильника или чека из магазина — я распознаю продукты и аккуратно разложу их.", delay: 1500 },
  { id: 'onb3', text: "🎙 Скажи голосом: «Купил молоко и яйца» или «Съел на обед борщ со сметаной» — я всё занесу в нужный раздел.", delay: 2600 },
  { id: 'onb4', text: "🍽 В Дневнике можно удобно следить за съеденными калориями, нормой и выпитой водой.", delay: 3800 },
  { id: 'onb5', text: "✨ Свайпай элементы влево-вправо (никаких кнопок-плюсиков!). А добавить новые — через синюю AI-кнопку.", delay: 5000 },
];
...
export default function App() {
  ...
  const { 
    ...
    stats, calorieNorm, setCalorieNorm, macroNorms, setMacroNorms,
        ...
        <Suspense fallback={<div style={{ display: 'flex', justifyContent: 'center', paddingTop: '50%', opacity: 0.3 }}>⏳</div>}>
          ...
          {currentTab === 'settings' && (
            <SettingsScreen
              ...
              macroNorms={macroNorms}
              onUpdateMacroNorms={setMacroNorms}
