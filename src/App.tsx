...
const ONBOARDING_STEPS = [
  ...
  { id: 'onb2', text: "📸 Скинь фото холодильника или чека из магазина — я распознаю продукты и аккуратно разложу их.", delay: 2800 },
  { id: 'onb3', text: "🎙 Скажи голосом: «Купил молоко и яйца» или «Съел на обед борщ со сметаной» — я всё занесу в нужный раздел.", delay: 4800 },
  { id: 'onb4', text: "🍽 В Дневнике можно удобно следить за съеденными калориями, нормой и выпитой водой.", delay: 6800 },
  { id: 'onb5', text: "✨ Свайпай элементы влево-вправо (никаких кнопок-плюсиков!). А добавить новые — через синюю AI-кнопку.", delay: 8500 },
];
